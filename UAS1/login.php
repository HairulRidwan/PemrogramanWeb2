...
<head>
    ...
    <title>DATA PENERIMA BANTUAN COVID-19</title>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <center>
                        ...
                        <h3 class="panel-title">DATA COVID-19</h3>
                        <p><small>COVID-19</small></p>
                    </center>
                    </div>
                    <div class="panel-body">
                        <form action="config/proses_login.php" method="post">
                            <fieldset>
                                ...
                                <hr>
                                <p class="text-center">Distributed By <a href="https://GALIH.com" target="_blank" rel="noopener noreferrer">GALIH.com</a></p>
                            </fieldset>
                        </form>
                    </div>
                </div>
